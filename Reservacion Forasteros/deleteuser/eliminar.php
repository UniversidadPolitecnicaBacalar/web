		...
		<div class="row animated fadeIn retraso-1">
			<div class="col s6 offset-s3">
				<ul class="collapsible" data-collapsible="accordion">
		        	<li>
			            <div class="collapsible-header active white-text"><i class="material-icons white000">cancel</i>Eliminar Usuarios</div>
			            <div class="collapsible-body">
							...
							while($fila = mysql_fetch_assoc($usuario)) { 
								echo "<tbody>"; 
									...
									echo "<td>".'<a class="btn-floating btn waves-effect waves-light red" href="delete.php?id=' . $fila['idalta_login'] .'"><i class="material-icons">delete</i></a> '."</td>";
									echo "</tr>";
								echo "</tbody>"; 
							} 
							echo "</table>";
