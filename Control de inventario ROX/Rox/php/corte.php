            ...
            <table id="tablaProductos" class = "responsive-table bordered hoverable centered" name = "tabla_productos">
              <thead>
                <tr>
                    ...
                    <th data-field="Costo"><i class="mdi-editor-attach-money"></i>Precio de <br>Aquisición</th>
                    ...
                    <table id = "corteProductos" class = "responsive-table bordered hoverable centered ">
                      <thead>
                        <tr>
                            ...
                            <th>Nombre</th>
                            <th>Marca</th>
                            <th>$ Precio de <br> Adquisición</th>
                            <th>$ Precio al <br> Público</th>
                            <th>Stock</th>
                            <th>Eliminar</th>
                        </tr>
                      </thead>
            ...
            <div class="modal-footer">
              <div class="row">
                <div class="input-field col 6 right">
                  <button class="btn blue waves-light" onclick="location='corte.php'" >Cerrar</button>
                </div>
              </div>
            </div>
          </div>
