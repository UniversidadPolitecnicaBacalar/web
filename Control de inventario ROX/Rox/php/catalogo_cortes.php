            ...
            <tbody>
              ...
              <?php
                  ...
                  while($pro = mysql_fetch_array($consulta)){
                    ...
                    <td><a class = 'mdi-av-my-library-books btn-floating blue' target = '_blank' href =".$pro['ruta']."></a></td>
                    <td><a class = 'mdi-action-visibility btn-floating' target = '_blank' href =ver.php?id=".$pro['Id_corte']."></a></td>
                    <td><a class = 'mdi-action-visibility btn-floating' target = '_blank' href =grafica.php?id=".$pro['Id_corte']."></a></td>
            ...
            <div class="modal-footer">
              <div class="row">
                <div class="input-field col 6 right">
                  <button class="btn blue waves-light" onclick="location='catalogo_cortes.php'" >Cerrar</button>
                </div>
              </div>
            </div>
          </div>
