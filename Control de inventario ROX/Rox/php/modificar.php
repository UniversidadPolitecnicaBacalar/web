          ...
          <div class = "nav-wrapper  blue darken-2">
            ...
            <a href="#" class = "brand-logo center"><i class = "mdi-editor-mode-edit"></i></a>
             ...
             <ul class="right"><!-- Menu Cuenta de usuario -->
                  ...
                  ?>
                <li><a class="dropdown-button tooltipped" data-tooltip="Cuenta" data-position="bottom" data-activates="dropdown1"><img src="<?php echo $ruta; ?>" alt="" class="circle left" width = "55px" height = "55px" id="imagenCuenta">&nbsp;&nbsp;<?php echo $_SESSION['username']?><i class="mdi-navigation-arrow-drop-down right"></i></a></li>                <ul id='dropdown1' class='dropdown-content large'>
                        ...
                        <form class="col s12" id="formulario_producto" autocomplete="off">
                          ...
                          <div class="row">
                            <div class="input-field col s6">
                              ...
                              <label for="icon_prefix">Precio de Adquisición</label>
                            </div>
                            <div class="input-field col s6">
                              <i class="mdi-editor-attach-money prefix"></i>
            ...
            <div class="modal-footer">
              <div class="row">
                <div class="input-field col 6 right">
                  <button class="btn blue waves-light" onclick="location='modificar.php'" >Cerrar</button>
                </div>
              </div>
            </div>
          </div>
