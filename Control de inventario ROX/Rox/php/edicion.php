                        ...
                        <tbody>
                          ...
                          while($pro = mysql_fetch_array($consulta)){
                            ...
                            echo '<tr>
                                ...
                                <td>'.$pro['numero'].'</td>
                                <td>'.$pro['direccion'].'</td>
                                <td><button onclick = "modificarEstatus(\''.$pro['Id_usuario'].'\',\''.$pro['username'].'\',1)" disabled class="btn-floating btn-large waves-effect waves-light grey"><i class = "mdi-social-mood"></i></button></td>
                                <td><button onclick = "modificarEstatus(\''.$pro['Id_usuario'].'\',\''.$pro['username'].'\',0)" class="btn-floating btn-large waves-effect waves-light red"><img id="cara1" src = "../images/ic_mood_bad_black_24px.svg"></button></td>
                              </tr>';
               
                            }

                            elseif($pro['estatus'] == 0){
                            ...
                            echo '<tr>
                                ...
                                <td>'.$pro['numero'].'</td>
                                <td>'.$pro['direccion'].'</td>
                                <td><button onclick = "modificarEstatus(\''.$pro['Id_usuario'].'\',\''.$pro['username'].'\',1)" class="btn-floating btn-large waves-effect waves-light blue"><i class = "mdi-social-mood"></i></button></td>
                                <td><button onclick = "modificarEstatus(\''.$pro['Id_usuario'].'\',\''.$pro['username'].'\',0)" disabled class="btn-floating btn-large waves-effect waves-light grey"><img id="cara1" src = "../images/ic_mood_bad_black_24px.svg"></button></td>
                              </tr>';
            ...
            <div class="modal-footer">
              <div class="row">
                <div class="input-field col 6 right">
                  <button class="btn blue waves-light" onclick="location='edicion.php'" >Cerrar</button>
                </div>
              </div>
            </div>
          </div>
