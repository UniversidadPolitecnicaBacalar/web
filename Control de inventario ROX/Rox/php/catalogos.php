                    ...
                    <table id = "movimientosTabla" class = "responsive-table bordered hoverable centered ">
                        ...
                        <tbody>
                          ...
                          while($pro = mysql_fetch_array($consulta)){
                            ...
                            $nombreItem = $nombreProducto['descripcion'];

                            $Provedores = mysql_query("SELECT Id_provedor FROM `productos` WHERE descripcion = '".$nombreItem."'");
                            $Id_provedor = mysql_fetch_assoc($Provedores);


                            $provedor = mysql_query("SELECT nombre FROM provedores WHERE Id_provedor = '".$Id_provedor['Id_provedor']."'");
            ...
            <div class="modal-footer">
              <div class="row">
                <div class="input-field col 6 right">
                  <button class="btn blue waves-light" onclick="location='catalogos.php'" >Cerrar</button>
                </div>
              </div>
            </div>
          </div>
