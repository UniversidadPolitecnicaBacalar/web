...
<html>
  ...
  <!-- main -->
                        ...
                        <form class="col s12" id = "formulario_producto" autocomplete="off">
                          ...
                          <div class="row">
                            <div class="input-field col s6">
                              ...
                              <label for="icon_prefix">Precio de adquisición o elaboración</label>
                            </div>
                            <div class="input-field col s6">
                              <i class="mdi-editor-attach-money prefix"></i>
                        ...
                        <form class="col s12" id="formulario_cliente" autocomplete="off">
                          ...
                          <div class="row">
                            ...
                            <div class="input-field col s6">
                              ...
                              <label for="icon_prefix">CP</label>
                            </div>
            ...
            <div class="modal-footer">
              <div class="row">
                <div class="input-field col 6 right">
                  <button class="btn blue waves-light" onclick="location='altas.php'" >Cerrar</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <footer class="page-footer blue darken-2">
          <div class="footer-copyright pie3">
            <div class="container">
