          ...
          <div style="margin-left:0.4444444444%">  
            ...
            ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="nombreActividad" placeholder="Nombre de la unidad">
                </div>
              </div>
              <br><br>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="submit" id="guardarActividad" class="btn btn-default" data-loading-text="Guardando...">Guardar actividad</button>
...
<script>
  ...
  $( "#guardarActividad" ).click(function() {
    ...
    $.post("modulos/guardarActividad.php",{idMateria:'<?= $idMateria ?>', nombreActividad:$('#nombreActividad').val(), evidencia:$('#evidencia').val(), unidad:$('#unidad').val()},function(html){
          console.log(html);          
