...
<a href="materia.php?idMateria=<?= $idMateria ?>" style="position: absolute;margin-left: 0.3333333%;width:190px;" class="btn btn-default"><span class="glyphicon glyphicon-step-backward"></span>Regresar</a> <br><br><br> 
          <div style="margin-left:0.4444444444%">  
            ...
            <?php 
              $ssql="SELECT * FROM tb_temaunidad ORDER BY id_temaU DESC LIMIT 1";
              $result=$mysqli->query($ssql);
              $row=mysqli_fetch_array($result);
              $idUltimo=$row["id_temaU"];
              $idUltimo ++;
            ...
            ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" value="<?= $idUltimo ?>" disabled>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="nombreUnidad" placeholder="Nombre de la unidad">
                </div>
              </div>
              <br><br>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="submit" id="guardarMateria" class="btn btn-default" data-loading-text="Guardando...">Guardar unidad</button>
...
<script>
  ...
  $( "#guardarMateria" ).click(function() {
    ...
    $.post("modulos/guardarUnidad.php",{idMateria:'<?= $idMateria ?>', nombreUnidad:$('#nombreUnidad').val()},function(html){
          console.log(html);          
