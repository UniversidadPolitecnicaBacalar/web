                      ...
                      <div class="row-fluid">
                          <div class="span6">
                              <h1 class="text-info">
                                    ...
                                    Clave de actividad: <?= $idActividad; ?><br>
          ...
          <div style="margin-left:0.4444444444%">  
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            ...
                            <?php
                                    ...
                                    INNER JOIN tb_actividad act ON (act.idact = aact.tb_actividad_idact 
                                      AND aact.tb_actividad_idact=$idActividad)";
                                    ...
                                    ?>
                                                                ...
                                                                <tr class="even gradeC" id="entradaCell-<?php echo $id; ?>">
                                                                    ...
                                                                    <td ALIGN=CENTER class="center">
                                                                      ...
                                                                      <input type="text" style="width:40px;height:25px" id="calificacion" value="<?= $calificacion ?>">
                  ...
                  <button type="submit" id="guardarCalif" class="btn btn-default" data-loading-text="Guardando...">Guardar cambios</button>
...
<script>
  ...
  $( "#guardarCalif" ).click(function() {
    ...
    $.post("modulos/guardarCalif.php",{idCalifica:'<?= $id ?>', calificacion:$('#calificacion').val()},function(html){
          console.log(html);          
