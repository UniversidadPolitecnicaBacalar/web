                ...
                <form class = "col s12" id="alta_usuario" enctype="multipart/form-data" autocomplete="off">
                  ...
                  <div class="row">
                    ...
                    <div class="file-field input-field col s6">
                      ...
                      <div class="btn">
                        <span>Foto</span>
                        <input type="file" name = "uploadedfile" accept="image/png,image/jpeg,image/gif" />
                      </div>
                    </div>
                  </div>
    ...
    <footer class="page-footer blue">
      ...
      <script>   
        $(function(){
         ...
         var url = "userSaved.php"; // El script a dónde se realizará la petición.
            $.ajax({
                   type: "POST",
                   url: url,
                   ...
                   success: function(data)
                   {
                      if(data == "Nuevo usuario guardado correctamente"){
                        ...
                        document.getElementById("userSaved").reset();// Mostrar la respuestas del script PHP.
