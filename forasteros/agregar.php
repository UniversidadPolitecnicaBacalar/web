<?php
	...
	if ($nombre=="" or $apellido=="" or $user=="" or $pass=="" or $pass1==""){
	 	...
	 	if($pass != $pass1){ 
			...
			exit;
			 ...
			 $query = "INSERT INTO alta_login (nombre, apellido, usuario, password) VALUES ('$_REQUEST[nombre]','$_REQUEST[apellido]','$_REQUEST[usuario]', '$pass' )";
