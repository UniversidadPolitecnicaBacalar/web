    ...
    date_default_timezone_set("America/Mexico_City");
      $hoy = date("Y-m-d");
            ...
            if (!$conexion) {
              ...
              // Conexion exitosa
              $sql = "SELECT iddatos_reservacion, nombre, telefono, no_personas, fecha, hora, minuto, comentario  FROM datos_reservacion WHERE fecha='$hoy' AND status='0'";
                ...
                // imprime los datos
                      ...
                      while($campo = mysqli_fetch_assoc($resultado)) {
                        ...
                        echo "<tbody>";
                          ...
                          echo "<td> <form action='tabla.php' method='post'><button class='btn waves-effect waves-light' type='submit' name='action'>Confirmar<i class='material-icons'>done</i></button></form> </td>";
                          echo "</tr>";
                        echo "</tbody>";
                      }
                      echo "</table>";      
