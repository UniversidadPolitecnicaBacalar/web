	...
	<main>
		...
		<div class="row animated fadeIn retraso-1">
			<div class="col s8 offset-s2">
				...
				// Pasamos el id seleccionado a una sesión y las demás filas = campos. 
				...
				<form action="campo_delete.php" method="post">  
			    ...
			    <div class="row center"> 
					<button class="btn-floating btn waves-effect waves-light red" type="submit" value="Editar" name="action">
			    	<i class="material-icons">delete</i>
			  		</button>
				</div>
				<div class="row center"> 
					<a class="waves-effect waves-light btn" href="eliminar.php" target="_self"><i class="material-icons left">keyboard_backspace</i>Regresar</a>
				</div>
				</form>
		</div>
	</main>
