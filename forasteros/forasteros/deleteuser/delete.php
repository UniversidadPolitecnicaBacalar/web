...
?> 
<a href="actualizar.php" target="_self">Atras</a><br />  
<form action="campo_delete.php" method="post">   
<br />  
Usuario:  
<br />  
<input type="text" name="usuario" value="<?php echo $_SESSION['usuario'];?>"> <br/><br/>  
<input type="hidden" name="idalta_login" value="<?php echo $id; ?>">
Contrasenia: 
 <br />  
