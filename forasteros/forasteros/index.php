      ...
      <div class="container">
        <div class="row center">
          <div class="animated fadeIn retraso-1">
            ...
            <h5 class="header col s10 offset-s1 light">El mejor lugar para cenar</h5>
          </div>
        </div>
        ...
        <div class="row"> <!--Esto es una fila-->
          <div class="col s12 m4"> <!--Esto es para colocarlos, exactamente no se para que sirve el s12 pero el m4 si lo mueves el texto se acomoda a horizontal-->
            <div class="icon-block">
              ...
              <p class="center text">¡Aparta tu mesa preferida el dia hoy, mañana o el dia que prefieras! Ven y cena con nosotros.</p>
            </div>
          </div>
          <div class="col s12 m4">
            <div class="icon-block" >
              <h2  class="center text"><a href="#!"><i class="material-icons brown000">contact_phone</i></a></h2>
              <h5 class="center"><span class="black-text ">Servicio a domicilio</span></h5>
              <p class="center text">Ordena ahora mismo tu cena favorita al numero telefonico 01 983 833 1500</p>
            </div>
          </div>
