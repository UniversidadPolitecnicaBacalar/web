...
$busqueda = $_POST['busqueda_alumno'];
...
#variable donde trae todo de la base de datos  #donde ______________  como ______________   #si hay problemas la funcion nos indica cual es
$registro = mysql_query("SELECT * FROM alumnos WHERE Apellido_paterno LIKE '%$busqueda%' 
												OR Apellido_materno LIKE '%$busqueda%' 
												OR Nombre LIKE '%$busqueda%'
												OR Lugar_de_nacimiento LIKE '%$busqueda%'
												OR Fecha_de_nacimiento LIKE '%$busqueda%'
												OR Domicilio LIKE '%$busqueda%'
												OR Ciudad LIKE '%$busqueda%'
												OR Colonia LIKE '%$busqueda%' 
												OR ID LIKE '%$busqueda%'
												OR Numero_exterior LIKE '%$busqueda%'
												OR Telefono_movil LIKE '%$busqueda%'
												OR Telefono_fijo LIKE '%$busqueda%' ORDER BY ID ASC") or die ("Problemas en consulta".mysql_error());
